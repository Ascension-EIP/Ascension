...
> **Important**: Never write "Copilot", "Claude", "Gemini", or any AI name as the author (per Author Attribution Rule in `instructions.md`). Use the git committer's name or omit the `@author` line if unknown.
