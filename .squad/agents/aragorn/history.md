...
- Samwise created `.github/workflows/squad-pr-review.yml` for automated PR routing.
- All PRs now auto-labeled with `squad:{agent}` based on changed file paths.
- Cross-domain PRs (>2 agents) automatically assigned to Aragorn for architectural review.
