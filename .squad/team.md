...
**Stack:** Flutter (mobile), Go/Gin (API Gateway), Python/PyTorch/MediaPipe/OpenCV (AI Workers), RabbitMQ (messaging), PostgreSQL (database), MinIO/S3 (object storage), Docker Compose
**User:** Gianni TUERO
**Created:** 2026-03-02
...
| Renaud | Backend Dev | Go, Gin, JWT, pgx, WebSockets, API Gateway | 🔧 |
...
| Sophie | Session Logger | Memory, decisions, session logs | 📋 |
| Ralph | Work Monitor | Work queue, backlog, keep-alive | 🔄 |

## Architecture Overview

- **Layer 1:** Flutter mobile app — video capture, overlay rendering, WebSocket
- **Layer 2:** Go API Gateway (Gin) — auth, validation, presigned URLs, job orchestration
