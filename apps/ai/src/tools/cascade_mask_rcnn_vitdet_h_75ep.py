...
from fvcore.common.param_scheduler import MultiStepParamScheduler  # noqa: E402

from detectron2 import model_zoo  # noqa: E402
from detectron2.config import LazyCall as L  # noqa: E402
from detectron2.solver import WarmupParamScheduler  # noqa: E402
from detectron2.modeling.backbone.vit import get_vit_lr_decay_rate  # noqa: E402
...
train.init_checkpoint = (
    "detectron2://ImageNetPretrained/MAE/mae_pretrain_vit_base.pth"
)
...
from detectron2.config import LazyCall as L  # noqa: E402, F811
from detectron2.layers import ShapeSpec  # noqa: E402
from detectron2.modeling.box_regression import Box2BoxTransform  # noqa: E402
from detectron2.modeling.matcher import Matcher  # noqa: E402
from detectron2.modeling.roi_heads import (  # noqa: E402
...
model.roi_heads.update(
    ...
    proposal_matchers=[
        L(Matcher)(
            thresholds=[th], labels=[0, 1], allow_low_quality_matches=False
        )
...
from functools import partial  # noqa: E402, F811
