...
- **Enregistrement des grimpes :** Recommandations d'angle et de luminosité pour filmer efficacement une voie ou un bloc.
- **Restitution de l'analyse :** Interprétation des scores, visualisation du squelette 2D/3D et conseils du coach virtuel.
- **Mode Fantôme & Programmes :** Utilisation de l'overlay de comparaison et suivi de programmes d'entraînement sur-mesure.
