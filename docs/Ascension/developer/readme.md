...
Shared domain vocabulary bridging climbing fundamentals (_beta_, _crux_, _crimp_, _sloper_), biomechanical metrics (center of mass, joint angles, center of gravity), and system architecture concepts.
