---
id: aa084479-25cf-4486-9a98-c2609adbf9c7
---
...
**Name:** `ascension-ci` **Triggers:** Every `push` and `pull_request` event (ignoring `docs/**` and `*.md`).
...
**Name:** `ascension-detect-no-ci` **Triggers:** Reusable `workflow_call`.
...
**Name:** `ascension-dev-to-staging` **Triggers:**
...
**Name:** `ascension-staging-to-main` **Triggers:** Manual dispatch (`workflow_dispatch` with `version_bump` input: `patch`, `minor`, `major`).
...
**Name:** `ascension-vps-deploy` **Triggers:**
...
**Name:** `ascension-gemini-pr-review` **Triggers:**
