...
This guide walks you through adding a new HTTP route to the server from scratch. It assumes you have read the [architecture overview](../../../../Developer/apps/server/architecture.md) first.
