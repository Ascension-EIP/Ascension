---
id: 3fa5fcba-28c9-4e5a-a0e5-cf5e3132550d
---
...
Markdown files named `README.md` under `docs/` are excluded by the generator. Use `index.md` as the entry page for directories that must appear in the Wiki.