---
id: 42c36184-eebe-4eb2-a1ff-7c321c112c49
---
...
The Technical Track transforms you from a coder into a technical architect. You will dive deep into emerging technologies, master the art of making informed technical decisions, and learn to build systems that are not just functional, but scalable, maintainable, and secure. This journey is about developing the technical leadership skills that distinguish great engineers from good developers.

Throughout this track, you will embrace the full spectrum of technical excellence. You will conduct rigorous technology evaluation and integration, architect robust and well-documented systems, engage with the open-source community, collaborate with technical experts, and optimize for performance at every level. Each objective pushes you to think critically about technology choices and their long-term implications.

This guide outlines the comprehensive framework for your Technical Track journey. It details mandatory objectives that will challenge your technical depth, as well as complementary goals you will select with your mentor to align with your project’s specific technical ambitions. Clear deliverables and evaluation criteria ensure you understand what technical excellence means in practice.

While pursuing these technical objectives, remember that you will continue developing your project’s functionality and collaborative aspects in parallel. The workload will fluctuate throughout the year, with certain periods demanding deeper technical focus. Strong time management and regular communication with your mentor and the EIP academic coordinator are crucial. They are here to challenge your architectural decisions, validate your technical choices, and help you navigate the demanding but rewarding path of technical innovation.
...
- Comparative sheets or benchmark tables.

- POCs or mini-projects testing technologies (separate repositories or dedicated branches).

- Changelog and README detailing the integration performed.

- Documented rationale for final (or rejected) choices.
...
- Choosing a solution only because it is trendy.
...
- Changelog or technical plan.

- Example configuration files (development and production).

- Code-quality reports (ESLint, Sonar, etc.).

- Screens or results of unit, stress, or validation tests.
...
- No error handling or configuration management.

- An unjustified stack (“because we know React”).
...
- Proof of exchange (meeting, Slack, message, GitHub comment, etc.).

- Memo or post-collaboration analysis note.
...
- Repeating only what the EIP mentor said without seeking an external view.
...
- Scripts or tools used for tests (e.g., JMeter `.jmx`, Docker, etc.).

- Monitoring or benchmark dashboards (screenshots).
...
- Relying only on intuition or habit.

- Only reducing image or static file size without measured impact.

- Failing to document obtained results.