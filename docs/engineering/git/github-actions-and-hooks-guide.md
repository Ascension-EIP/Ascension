---
id: 081cfb41-f1f9-42ca-afbd-ec8c403cee5a
---

> **Last updated:** 26th February 2026 **Version:** 1.1 **Authors:** Nicolas TORO **Status:** Done {.is-success}
...
- [GitHub Actions & Hooks Guide](#github-actions--hooks-guide)
  ...
  - [5\. GitHub Actions workflows](#5-github-actions-workflows)
    ...
    - [5.1 CI workflow (](#51-ci-workflow-ciyml)`ci.yml`[)](#51-ci-workflow-ciyml)
      ...
      - [Job:](#job-check_commit_and_branch) `check_commit_and_branch`

      - [Job:](#job-check_server-needs-check_commit_and_branch) `check_server` [(needs:](#job-check_server-needs-check_commit_and_branch) `check_commit_and_branch`[)](#job-check_server-needs-check_commit_and_branch)

      - [Job:](#job-check_mobile-needs-check_commit_and_branch) `check_mobile` [(needs:](#job-check_mobile-needs-check_commit_and_branch) `check_commit_and_branch`[)](#job-check_mobile-needs-check_commit_and_branch)

      - [Job:](#job-check_ai-needs-check_commit_and_branch) `check_ai` [(needs:](#job-check_ai-needs-check_commit_and_branch) `check_commit_and_branch`[)](#job-check_ai-needs-check_commit_and_branch)

    - [5.2 Deploy workflow (](#52-deploy-workflow-deployyml)`deploy.yml`[)](#52-deploy-workflow-deployyml)

      - [Job:](#job-build_and_push_server) `build_and_push_server`

      - [Job:](#job-build_and_push_mobile) `build_and_push_mobile`

      - [Job:](#job-create_release-needs-build_and_push_server-build_and_push_mobile) `create_release` [(needs:](#job-create_release-needs-build_and_push_server-build_and_push_mobile) `build_and_push_server`[,](#job-create_release-needs-build_and_push_server-build_and_push_mobile) `build_and_push_mobile`[)](#job-create_release-needs-build_and_push_server-build_and_push_mobile)

    - [5.3 Dev-to-production workflow (](#53-dev-to-production-workflow-dev-to-productionyml)`dev-to-production.yml`[)](#53-dev-to-production-workflow-dev-to-productionyml)

      - [Job:](#job-merge_branch) `merge_branch`

      - [Job:](#job-create_tag-needs-merge_branch) `create_tag` [(needs:](#job-create_tag-needs-merge_branch) `merge_branch`[)](#job-create_tag-needs-merge_branch)

      - [Job:](#job-mirror_repository-needs-merge_branch) `mirror_repository` [(needs:](#job-mirror_repository-needs-merge_branch) `merge_branch`[)](#job-mirror_repository-needs-merge_branch)

    - [5.4 Docs-to-wiki workflow (](#54-docs-to-wiki-workflow-docs-to-wikiyml)`docs-to-wiki.yml`[)](#54-docs-to-wiki-workflow-docs-to-wikiyml)

      - [Job:](#job-update_wiki) `update_wiki`

    - [5.5 Squad triage workflow (](#55-squad-triage-workflow-squad-triageyml)`squad-triage.yml`[)](#55-squad-triage-workflow-squad-triageyml)

      - [Job:](#job-triage) `triage`

    - [5.6 Squad issue assign workflow (](#56-squad-issue-assign-workflow-squad-issue-assignyml)`squad-issue-assign.yml`[)](#56-squad-issue-assign-workflow-squad-issue-assignyml)

      - [Job:](#job-assign-work) `assign-work`

    - [5.7 Squad label cleaner workflow (](#57-squad-label-cleaner-workflow-squad-label-cleaneryml)`squad-label-cleaner.yml`[)](#57-squad-label-cleaner-workflow-squad-label-cleaneryml)

      - [Job:](#job-clean_labels) `clean_labels`

    - [5.8 Squad pull request review workflow (](#58-squad-pull-request-review-workflow-squad-pull-request-reviewyml)`squad-pull-request-review.yml`[)](#58-squad-pull-request-review-workflow-squad-pull-request-reviewyml)

      - [Job:](#job-route-review) `route-review`

    - [5.9 Sync squad labels workflow (](#59-sync-squad-labels-workflow-sync-squad-labelsyml)`sync-squad-labels.yml`[)](#59-sync-squad-labels-workflow-sync-squad-labelsyml)

      - [Job:](#job-sync-labels) `sync-labels`
...
**Language:** Python 3 **Usage:** `.github/scripts/check_branch <branch_name>`
...
**Language:** Python 3 **Usage:** `.github/scripts/check_commit "<commit_message>"`
...
**Language:** Bash **Usage:** `.github/scripts/check_push`

A placeholder script intended for additional pre-push validations (e.g., running tests locally before pushing). Currently always exits with `0` (all checks pass).

> 🔧 This script is intended to be extended with project-specific checks in the future.

### 4.4 `reformat_code`

**Language:** Bash **Usage:** `.github/scripts/reformat_code`
...
**Language:** Bash **Usage:** `.github/scripts/get_commits_list`

A utility script that prints the list of commits between `origin/dev` and the current branch. Useful for reviewing what will be included in a pull request.
...
**Language:** Python 3 **Usage:** `.github/scripts/generate_wiki`
...
**Name:** `ascension-ci` **Triggers:** Every `push` and `pull_request` event.
...
**Name:** `ascension-deploy` **Triggers:** Push of a tag matching the pattern `v*` (e.g., `v0.1.0`).
...
**Name:** `ascension-dev-to-production` **Triggers:** Manual dispatch (`workflow_dispatch`) only.
...
**Name:** `ascension-docs-to-wiki` **Triggers:**
...
**Name:** `ascension-squad-triage` **Triggers:** `issues` event — `labeled` type, only when the label `squad` is applied.
...
**Name:** `ascension-squad-issue-assign` **Triggers:** `issues` event — `labeled` type, only for labels starting with `squad:`.
...
**Name:** `ascension-squad-label-cleaner` **Triggers:** `issues` event — `labeled` type, for any label.
...
**Name:** `ascension-squad-pull-request-review` **Triggers:** `pull_request` event — `opened`, `synchronize`, `reopened`.
...
**Name:** `ascension-sync-squad-labels` **Triggers:**
