---
id: 087544f5-ddfd-4d13-95a8-e03223d879b6
---
...
**Project:** Ascension — Climbing video analysis platform **Stack:** Python, PyTorch, MediaPipe, OpenCV, pika (RabbitMQ), psycopg2/asyncpg (PostgreSQL), boto3/minio (S3) **User:** Gianni TUERO