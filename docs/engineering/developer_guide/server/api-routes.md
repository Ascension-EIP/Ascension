---
id: a813ec3b-f99d-492b-bf86-1eeeae093376
---
...
> **Authentication is partially implemented.** JWT middleware exists for `/healthz` but is not yet applied to the `/v1/*` routes. All `/v1/*` routes are currently accessible without a token.
