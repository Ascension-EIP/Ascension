---
id: d6e085bd-4842-45ea-b764-4790308d9b93
---
...
- Update le GitHub projects @nicolas\_toro
...
ya une IA qui transforme une photo en depth-map (on peut le combiner avec une autre qui segmente le corps (genre avant-bras, poignet etc)) et à partir de là on pourrait faire une visu 3D plutot qu'un exosquelette en 2D C'est SAM (de Meta) l'ia

@EIP **Pour résumé suite à notre conversion**
...
- @dimitri\_lapoudre va s'occuper d'init le back et de travailler sur les premières routes

- @nicolas\_toro va s'occuper de tous les trucs pro, GitHub projects etc, et ensuite je rejoindrais Lou et on s'organisera.
